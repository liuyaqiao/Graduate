...
// of the Dijkstra algorithm in this document.
    Graph g4(6);
    g4.AddUndirectedEdge(0, 1, 14);
    g4.AddUndirectedEdge(0, 4, 7);
    g4.AddUndirectedEdge(0, 5, 9);
    g4.AddUndirectedEdge(1, 2, 9);
    g4.AddUndirectedEdge(1, 5, 2);
    g4.AddUndirectedEdge(2, 3, 6);
    g4.AddUndirectedEdge(3, 4, 15);
    g4.AddUndirectedEdge(3, 5, 11);
    g4.AddUndirectedEdge(4, 5, 10);
    g4.Dijkstra(0);
// Print graph and shortest paths
    std::cout << "** Dijkstra **\n";
    g4.Print();
